...
public class UsersInBulkByExternalIdsPostRequestBody implements AdditionalPropertiesAware {
  @JsonProperty("ids")
  ...
  public UsersInBulkByExternalIdsPostRequestBody withIds(Set<String> ids) {
    this.ids = ids;
    return this;
  }
  ...
  public boolean equals(Object other) {
    if (other == this)
      return true; 
    if (!(other instanceof UsersInBulkByExternalIdsPostRequestBody))
      return false; 
    UsersInBulkByExternalIdsPostRequestBody rhs = (UsersInBulkByExternalIdsPostRequestBody)other;
