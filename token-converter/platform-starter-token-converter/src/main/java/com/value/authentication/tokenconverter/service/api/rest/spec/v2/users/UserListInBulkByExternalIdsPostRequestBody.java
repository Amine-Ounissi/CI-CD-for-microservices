...
public class UserListInBulkByExternalIdsPostRequestBody implements AdditionalPropertiesAware {
  @JsonProperty("ids")
  ...
  public UserListInBulkByExternalIdsPostRequestBody withIds(Set<String> ids) {
    this.ids = ids;
    return this;
  }
  ...
  public boolean equals(Object other) {
    if (other == this)
      return true; 
    if (!(other instanceof UserListInBulkByExternalIdsPostRequestBody))
      return false; 
    UserListInBulkByExternalIdsPostRequestBody rhs = (UserListInBulkByExternalIdsPostRequestBody)other;
