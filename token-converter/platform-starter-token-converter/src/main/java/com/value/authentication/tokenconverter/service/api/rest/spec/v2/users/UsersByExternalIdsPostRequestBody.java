...
public class UsersByExternalIdsPostRequestBody implements AdditionalPropertiesAware {
  @JsonProperty("ids")
  ...
  public UsersByExternalIdsPostRequestBody withIds(Set<String> ids) {
    this.ids = ids;
    return this;
  }
  ...
  public boolean equals(Object other) {
    if (other == this)
      return true; 
    if (!(other instanceof UsersByExternalIdsPostRequestBody))
      return false; 
    UsersByExternalIdsPostRequestBody rhs = (UsersByExternalIdsPostRequestBody)other;
